...
class Profile(models.Model):
    ...
    movie_comments = models.ForeignKey(MovieComment)
    music_comments = models.ForeignKey(MusicComment)
    liked_movie_comments = models.ForeignKey(MovieComment)
    liked_music_comments = models.ForeignKey(MusicComment)
